...
char *commands[][100] = {
                            ...
                            {"create", "employee", "empid", "i", "emp_name", "s", "count", "i", NULL},
                            {"insert", "employee", "empid", "2", "emp_name", "a", "count", "11", NULL},
                            {"insert", "employee", "empid", "2", "emp_name", "b", "count", "11", NULL},
                            {"insert", "employee", "empid", "3", "emp_name", "c", "count", "12", NULL},
                            {"insert", "employee", "empid", "1", "emp_name", "d", "count", "11", NULL},
                            {"print", "employee", NULL},
